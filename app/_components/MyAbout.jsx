    ...
    <div className="m-6 sm:m-10 md:h-[550px] shadow-emerald-300 shadow-sm rounded-3xl bg-gray-400 dark:bg-inherit flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 p-4">
      <div className="text-white font-mono text-lg max-w-3xl">
        <p className="text-black dark:text-gray-300">
          <span className="text-pink-900 dark:text-pink-400">{"<span>"}</span>Selamlar herkese, ben{" "}
        ...
        <p className="mt-4 text-black dark:text-gray-300 text-base sm:text-lg">
          ...
          3 yıldır bu sektördeyim ve modern teknolojilerde uzmanlığımı kullanarak{" "}
          ...
          <span className="text-red-400">Artificial Intelligence ve Machine Learning</span> alanlarında çalışmalar yapmaktayım. Bunun
          yanı sıra, <span className="text-emerald-700 dark:text-emerald-200">etik hacking ve siber güvenlik alanlarına</span>{" "}
          merakım var. Yakın zamanda bu sektörlerde de deneyim sahibi olmayı planlıyorum.
          <span className="text-emerald-500">{"</p>"}</span>
        </p>
      </div>
